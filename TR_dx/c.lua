...
function getFont(size, family)
  ...
  local font = guiData.fonts[string.format("size_%s_%d", family and family or "Lato-Regular", size)]
...
function getBoldFont(size, family)
  -- local size = getFontSize(size)
  local font = guiData.fonts[string.format("size_%s_%d_bold", family and family or "Lato-Regular", size)]
  if not font then font = createBoldFont(size, family) end
  return font
end

function createFont(size, family)
  if family then print(family) end
  guiData.fonts[string.format("size_%s_%d", family and family or "Lato-Regular", size)] = dxCreateFont(string.format("files/fonts/%s.ttf", family and family or "Lato-Regular"), size, false)
  return guiData.fonts[string.format("size_%s_%d", family and family or "Lato-Regular", size)]
end

function createBoldFont(size, family)
  guiData.fonts[string.format("size_%s_%d_bold", family and family or "Lato-Regular", size)] = dxCreateFont(string.format("files/fonts/%s.ttf", family and family or "Lato-Regular"), size, true, family and "antialiased" or "cleartype_natural")
  return guiData.fonts[string.format("size_%s_%d_bold", family and family or "Lato-Regular", size)]
end
