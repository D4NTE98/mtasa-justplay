...
function Loading:draw()
  ...
  -- DODAĆ ALPHE
  dxDrawText("TIPS & TRICKS", 0,  sy/2-25/zoom - 10/zoom, sx, sy/2-25/zoom + 40/zoom, tocolor(44,181,233, 255 * self.alpha), 1/zoom, getFont(18, "Lato-Regular"), "center", "top", false, false, true)
  dxDrawText(self.tip, 0,  sy/2-25/zoom + 50/zoom, sx, sy/2-25/zoom + 40/zoom + 50/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, getFont(14), "center", "bottom", false, false, true)

  dxDrawImage(sx/2-142/zoom, 200/zoom, 284/zoom, 113/zoom, guiData.loading.bg.logo, 0, 0, 0, tocolor(255, 255, 255, 255 * self.alpha), true)
  dxDrawText(self.text, 0, sy - 280/zoom, sx, sy - 280/zoom + 50/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, getFont(13), "center", "center", false, false, true)
...
function Loading:animateLoader()
  for i, v in pairs(self.dots) do
    ...
    local r, g, b = interpolateBetween(255, 255, 255, 44,183,236, self.dots[i].progress, "Linear")
    dxDrawImage((sx - 90/zoom)/2 + 30/zoom * (i-1), sy - 200/zoom - 10/zoom * self.dots[i].progress, 30/zoom, 30/zoom, guiData.checkbox.check, 0, 0, 0, tocolor(r, g, b, 255 * self.alpha), true)
  end
end
...
if not getElementData(localPlayer, "characterUID") then
  setTimer(function()
    createdLoading:show(9999999, "Pobieranie zasobów")
  end, 1000, 1)
end
