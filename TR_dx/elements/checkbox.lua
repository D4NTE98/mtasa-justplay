...
function Checkbox:draw()
  ...
  dxDrawImage(self.x, self.y, self.w, self.h, guiData.checkbox.bg, 0, 0, 0, tocolor(34, 36, 43, 255 * self.alpha), true)
  dxDrawImage(self.x, self.y, self.w, self.h, guiData.checkbox.bg, 0, 0, 0, tocolor(34, 36, 43, 255 * self.alpha * self.alphaHover), true)
...
function Checkbox:setX(...)
  self.x = arg[1]
  return true
end

function Checkbox:setY(...)
  self.y = arg[1]
  return true
end
...
function setCheckX(...)
  if type(arg[1]) == "table" then
    for _, v in pairs(arg[1]) do
      createdChecks[v]:setX(arg[2])
    end
  else
    createdChecks[arg[1]]:setX(arg[2])
  end
  return true
end
...
function setCheckY(...)
  if type(arg[1]) == "table" then
    for _, v in pairs(arg[1]) do
      createdChecks[v]:setY(arg[2])
    end
  else
    createdChecks[arg[1]]:setY(arg[2])
  end
  return true
end
