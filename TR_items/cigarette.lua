...
function Cigarette:render()
    if self.tick then
        ...
        if self.canSmoke then
            dxDrawText("Naciśnij LPM aby wziąć bucha.\nNaciśnij PPM aby wyrzucić.", sx/2, guiInfo.y - 40/zoom, sx/2, guiInfo.y - 4/zoom, tocolor(255, 255, 255, 255), 1/zoom, self.font, "center", "bottom", false, false, false, true)
        end
