jobSettings = {
    name = "Praca motorniczego",
    desc = "Praca polega na prowadzeniu tramwaju po ulicach San Fierro. Musisz zatrzymywać się na wszystkich przystankach na swojej trasie i czekać aż wszyscy pasażerowie wsiądą i wysiądą z tramwaju. Każdy pasażer musi mieć bilet więc będą je od ciebie kupywać. Pamiętaj, że pasażerowie korzystają z dwóch rodzajów biletów. Nie pomyl się przy ich wydawaniu!",
    ...
    upgrades = {
        {
            name = "Większe miasto",
            desc = "Ulepszenie to sprawi, że na przystankach będzie czekać więcej pasażerów.",
            price = 200,
            type = "people",
            additionalMoney = {40, 70}
        },
        {
            name = "Nowe silniki elektryczne",
            desc = "Ulepszenie to sprawi, że tramwaj będzie mógł poruszać się szybciej.",
            price = 400,
            type = "tram",
