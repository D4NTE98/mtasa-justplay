...
function Courier:constructor(...)
    ...
    exports.TR_noti:create("Rozpocząłeś pracę jako kurier.", "job")
    exports.TR_jobs:createInformation(jobSettings.name, "Wsiądź do swojego samochodu dostawczego i podjedź na załadunek.")
...
function Courier:createLoadingPoints(blockGPS)
    ...
    for i, v in pairs(guiInfo.loadingPoints) do
        ...
        setElementData(marker, "markerData", {
            ...
            desc = "Wjedź tyłem aby załadować samochód.",
        }, false)
    ...
    exports.TR_jobs:setPlayerTargetPos(1448.3427734375, 1054.9501953125, 11.759575843811, 0, 0, "Załaduj samochód paczkami na bazie")
...
function Courier:loadVehicle(road)
    ...
    exports.TR_jobs:createInformation(jobSettings.name, "Trwa ładowanie pojazdu paczkami.")
...
function Courier:createNextDeliveryPoint()
    ...
    if self.deliveryPoint > #self.roadTable then
        ...
        exports.TR_jobs:createInformation(jobSettings.name, "Rozwiozłeś już wszystkie paczki. Wróć na bazę aby się załadować.")
        return
    end
    ...
    setElementData(marker, "markerData", {
        ...
        desc = "Wejdź w marker aby odłożyć paczkę.",
    }, false)
    ...
    exports.TR_jobs:setPlayerTargetPos(v.pos.x, v.pos.y, v.pos.z, 0, 0, "Dowieź paczkę do odbiorcy")
...
function Courier:buildDestinationText()
    ...
    guiInfo.list.y = exports.TR_jobs:createInformation(jobSettings.name, "Paczki do dowiezienia:\n ", #self.roadTable * guiInfo.fontHeight + 5/zoom)
end
