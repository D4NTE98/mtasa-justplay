...
local guiInfo = {
    tickets = {
        ...
        studentsTexts = {"Chciałbym bilet studencki."},
        standardTexts = {"Chciałbym bilet dla dorosłych."},
    },
...
function Bus:constructor(...)
    ...
    exports.TR_noti:create("Rozpocząłeś pracę jako kierowca autobusu.", "job")
...
function Bus:createMarkerPanel(blockGPS)
    ...
    setElementData(self.marker, "markerData", {
        title = "Zajezdnia",
        desc = "Zatrzymaj się aby wybrać trasę.",
    }, false)

    addEventHandler("onClientMarkerHit", self.marker, self.func.createBusPanel)
    exports.TR_jobs:createInformation(jobSettings.name, "Wjedź na zajezdnię aby wybrać trasę.")
    exports.TR_jobs:setPlayerTargetPos(pos.x, pos.y, pos.z, 0, 0, "Wjedź na zajezdnię by wybrać trasę")
...
function Bus:destroy()
    ...
    exports.TR_hud:setRadarCustomLocation("Wnętrze budynku | Canny Bus Group", true)
...
function Bus:createNextMarker()
    ...
    setElementData(self.marker, "markerData", {
        title = "Przystanek",
        desc = "Zatrzymaj się na przystanku aby zabrać pasażerów.",
    }, false)
    ...
    exports.TR_jobs:setPlayerTargetPos(pos.marker.x, pos.marker.y, pos.marker.z - 0.2, 0, 0, "Zatrzymaj się na przystanku.")
    exports.TR_jobs:createInformation(jobSettings.name, "Udaj się na kolejne miejsce postoju aby zabrać pasażerów z przystanku.")
...
function Bus:onMarkerHit(plr, md)
    ...
    self.noti = exports.TR_noti:create("Zatrzymaj się aby zabrać ludzi z przystanku.", "info", 10, true)
...
function Bus:render()
    ...
    dxDrawText("Wybierz odpowiedni bilet", guiInfo.tickets.x, guiInfo.tickets.y, guiInfo.tickets.x + guiInfo.tickets.w, guiInfo.tickets.y + 50/zoom, tocolor(240, 196, 55, 255 * self.alpha), 1/zoom, self.fonts.main, "center", "center")
