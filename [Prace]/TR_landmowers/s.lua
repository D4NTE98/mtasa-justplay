...
function createVehs()
    ...
    exports.TR_npc:addDialogueText(dialogue, "Siema. Jak się siedzi?", {pedResponse = "Powiem ci, że kozaczek. A ty co tak stoisz? Jak już rozładowałem te traktorki to możesz zacząć robić. Ten park musi się pięknie prezentować."})
    exports.TR_npc:addDialogueText(dialogue, "Nara.", {pedResponse = "No cześć."})

    local ped = exports.TR_npc:createNPC(206, -2406.220703125, 686.0478515625, 35.872165679932, 62, "Jim Lahely", "Ogrodnik", "dialogue")
