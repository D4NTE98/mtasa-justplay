...
addEventHandler("onClientColShapeHit", getResourceRootElement(), function(hit, md)
    ...
    if getElementData(localPlayer, "onAir") then exports.TR_noti:create("Nie możesz zbierać znajdziek latając na 0.", "error") return end
    ...
    if not last.collectibleHit or getTickCount()-last.collectibleHit > 5000 then
        ...
        exports.TR_noti:create("Poczekaj "..t.." s, aby ponownie spróbować odebrać znajdzkę.", "info")
        return
    end
end)
