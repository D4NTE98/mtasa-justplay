...
exports.TR_npc:addDialogueText(dialogueFlowers, "Chciałbym zakupić kwiaty.", {pedResponse = "", trigger = "buyFlowersToWoman"})
exports.TR_npc:addDialogueText(dialogueFlowers, "Do widzenia.", {pedResponse = "Do widzenia."})

local ped = exports.TR_npc:createNPC(12, -2576.583984375, 309.349609375, 22.6499996185, 0, "Amelie Post", "Sprzedawca kwiatów", "dialogue")
...
function createNpcs()
    ...
    exports.TR_npc:addDialogueText(dialogue, "Proszę. Mam dla ciebie kwiaty.", {pedResponse = "", trigger = "giveFlowersToWoman"})
...
function giveFlowersToWoman(ped)
    ...
    if flowersID and flowersID[1] then
        ...
        if flowersGiven and flowersGiven[1] then
            triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Dałeś mi już dzisiaj kwiaty! Więcej już nie chcę.", "files/images/npc.png")
        else
        ...
        triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Już się ucieszyłam a ty mnie okłamałeś! Nie masz dla mnie żadnych kwiatów!", "files/images/npc.png")
    end
end
...
function givePrize(plr, pedName)
    ...
    if rand < 1 then
        ...
        triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Ale piękny bukiet. Dziękuję! #C2A2DA*Daje $5000 za bukiet*", "files/images/npc.png")

    elseif rand < 5 then
        exports.TR_core:giveMoneyToPlayer(plr, 1000)
        triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Ale piękny bukiet. Dziękuję! #C2A2DA*Daje $1000 za bukiet*", "files/images/npc.png")

    elseif rand < 35 then
        exports.TR_core:giveMoneyToPlayer(plr, 500)
        triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Ale piękny bukiet. Dziękuję! #C2A2DA*Daje $500 za bukiet*", "files/images/npc.png")

    elseif rand < 85 then
        exports.TR_core:giveMoneyToPlayer(plr, 100)
        triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Ale piękny bukiet. Dziękuję! #C2A2DA*Daje $100 za bukiet*", "files/images/npc.png")

    else
        triggerClientEvent(client, "showCustomMessage", resourceRoot, pedName, "Ale piękny bukiet. Dziękuję! #C2A2DA*Daje buziaka w policzek*", "files/images/npc.png")
    end
end