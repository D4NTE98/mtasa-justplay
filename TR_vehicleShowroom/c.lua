...
function BuyVehicle:render()
    ...
    dxDrawText("Salon samochodowy", guiInfo.x, guiInfo.y, guiInfo.w + guiInfo.x, guiInfo.y + 50/zoom, tocolor(44,181,233, 255 * self.alpha), 1/zoom, self.fonts.name, "center", "center")
    ...
    if self.tab == "main" then
        ...
        if #self.avaliableVehicles > 6 then
            ...
            dxDrawRectangle(guiInfo.x + guiInfo.w - 8/zoom, guiInfo.y + 55/zoom, 4/zoom, 360/zoom, tocolor(34,36,43, 255 * self.alpha))
            dxDrawRectangle(guiInfo.x + guiInfo.w - 8/zoom, guiInfo.y + 55/zoom + barY, 4/zoom, barHeight, tocolor(42,45,51, 255 * self.alpha))
        else
            dxDrawRectangle(guiInfo.x + guiInfo.w - 8/zoom, guiInfo.y + 55/zoom, 4/zoom, 360/zoom, tocolor(34,36,43, 255 * self.alpha))
        end

    elseif self.tab == "fuelType" then
        dxDrawText("Wybierz rodzaj paliwa jaki chcesz posiadać w pojeździe.", guiInfo.x, guiInfo.y + 50/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.price, "center", "center")
        ...
        dxDrawText("Benzyna", guiInfo.x + 140/zoom, guiInfo.y + 310/zoom, guiInfo.x + 268/zoom, guiInfo.y + 310/zoom, tocolor(200, 200, 200, alpha * self.alpha), 1/zoom, self.fonts.fuel, "center", "center")
        ...
        dxDrawText("Diesel", guiInfo.x + guiInfo.w - 268/zoom, guiInfo.y + 310/zoom, guiInfo.x + guiInfo.w - 140/zoom, guiInfo.y + 310/zoom, tocolor(200, 200, 200, alpha * self.alpha), 1/zoom, self.fonts.fuel, "center", "center")

        dxDrawText("Łączna kwota:  $"..self:formatNumber(self.toPay), guiInfo.x, guiInfo.y + guiInfo.h - 10/zoom, guiInfo.w + guiInfo.x - 20/zoom, guiInfo.y + guiInfo.h - 50/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.name, "right", "center")

    elseif self.tab == "engineCapacity" then
        dxDrawText("Wybierz interesujący cię silnik.", guiInfo.x, guiInfo.y + 50/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.price, "center", "center")
    ...
    elseif self.tab == "selectColor" then
        dxDrawText("Wybierz interesujący cię kolor.", guiInfo.x, guiInfo.y + 50/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.price, "center", "center")
    ...
    elseif self.tab == "acceptBuy" then
        dxDrawText("Podsumowanie konfiguracji.", guiInfo.x, guiInfo.y + 50/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.price, "center", "center")

        dxDrawText("Łączna kwota:", guiInfo.x + 200/zoom, guiInfo.y + 110/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.price, "left", "top")
        dxDrawText("Rodzaj paliwa:", guiInfo.x + 200/zoom, guiInfo.y + 140/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.price, "left", "top")
        dxDrawText("Silnik:", guiInfo.x + 200/zoom, guiInfo.y + 170/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.price, "left", "top")
        dxDrawText("Kolor pojazdu:", guiInfo.x + 200/zoom, guiInfo.y + 200/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.price, "left", "top")
        dxDrawText("Pojemność baku:", guiInfo.x + 200/zoom, guiInfo.y + 230/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.price, "left", "top")
        dxDrawText("Średnie spalanie:", guiInfo.x + 200/zoom, guiInfo.y + 260/zoom, guiInfo.w + guiInfo.x, guiInfo.y + 100/zoom, tocolor(200, 200, 200, 200 * self.alpha), 1/zoom, self.fonts.price, "left", "top")

        dxDrawText("$"..self:formatNumber(self.toPay), guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 110/zoom, guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 100/zoom, tocolor(44,181,233, 200 * self.alpha), 1/zoom, self.fonts.price, "right", "top")
        dxDrawText(self.selectedFuel == "p" and "Benzyna" or "Diesel", guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 140/zoom, guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 100/zoom, tocolor(44,181,233, 200 * self.alpha), 1/zoom, self.fonts.price, "right", "top")
        dxDrawText(string.format("%s", self.selectedCapacity[1]), guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 170/zoom, guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 100/zoom, tocolor(44,181,233, 200 * self.alpha), 1/zoom, self.fonts.price, "right", "top")
        ...
        dxDrawText(string.format("%d l", self.vehicleTankCapacity), guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 230/zoom, guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 100/zoom, tocolor(44,181,233, 200 * self.alpha), 1/zoom, self.fonts.price, "right", "top")
        dxDrawText(string.format("%d l", self.vehicleFuel), guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 260/zoom, guiInfo.x + guiInfo.w - 200/zoom, guiInfo.y + 100/zoom, tocolor(44,181,233, 200 * self.alpha), 1/zoom, self.fonts.price, "right", "top")
    end
end
...
function BuyVehicle:drawShopVehicle(vehicle, i)
    ...
    if self:isMouseInPosition(guiInfo.x, guiInfo.y + move - 4/zoom, guiInfo.w - 9/zoom, 60/zoom) then
        dxDrawRectangle(guiInfo.x, guiInfo.y + move - 5/zoom, guiInfo.w - 9/zoom, 60/zoom, tocolor(16,18,23, 255 * self.alpha))
    end
    ...
    dxDrawText("Naciśnij, aby przejść do konfiguratora.", guiInfo.x + 80/zoom, guiInfo.y + 26/zoom + move, guiInfo.x + guiInfo.w, guiInfo.y + 40/zoom, tocolor(150, 150, 150, 200 * self.alpha), 1/zoom, self.fonts.desc, "left", "top")
    dxDrawText("$"..self:formatNumber(vehicle.price), guiInfo.x + guiInfo.w - 30/zoom, guiInfo.y + move, guiInfo.x + guiInfo.w - 30/zoom, guiInfo.y + 50/zoom + move, tocolor(44,181,233, 200 * self.alpha), 1/zoom, self.fonts.price, "right", "center")
end
...
function BuyVehicle:getVehicleName(veh)
    ...
    if model == 503 then return "Winstone" end
    if model == 502 then return "Lampadati Magnus" end
    if model == 605 then return "Ferroci 365 GTB4 Daytona Spyder '73" end
...
function BuyVehicle:drawShopVehicleCapacity(data, i)
    ...
    if i == self.selectedCapacity then
        dxDrawRectangle(sx/2 - 200/zoom, guiInfo.y + move, 400/zoom, 40/zoom, tocolor(42,45,51, 255 * self.alpha))
    elseif self:isMouseInPosition(sx/2 - 180/zoom, guiInfo.y + move, 400/zoom, 40/zoom) then
        dxDrawRectangle(sx/2 - 200/zoom, guiInfo.y + move, 400/zoom, 40/zoom, tocolor(34,36,43, 255 * self.alpha))
    else
        dxDrawRectangle(sx/2 - 200/zoom, guiInfo.y + move, 400/zoom, 40/zoom, tocolor(42,45,51, 255 * self.alpha))
    end

    dxDrawText(string.format("Silnik %s", data[1]), sx/2 - 190/zoom, guiInfo.y + move, guiInfo.x + guiInfo.w, guiInfo.y + move + 40/zoom, tocolor(220, 220, 220, 200 * self.alpha), 1/zoom, self.fonts.name, "left", "center")
    if data[2] >= 0 then
...
function BuyVehicle:canBuyVehicle()
    ...
    if self.vehicleCount >= limit then
        exports.TR_noti:create("Nie możesz zakupić tego pojazdu, ponieważ osiągnąłeś już limit. Ulepsz konto lub zakup dodatkowe miejsce w sklepie.", "error")
        return false
    end
    ...
    exports.TR_noti:create("Ten pojazd został już zakupiony.", "error")
    return false
end
...
function vehicleShopResponse(...)
    ...
    if arg[1] then
        ...
        exports.TR_noti:create("Pojazd został pomyślnie zakupiony.", "success")
        return
    end
    exports.TR_noti:create("Transakcja została odrzucona.", "error")
end
