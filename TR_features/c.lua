local settings = {
    featureData = {
        ["strenght"] = {
            textUp = {"CECHA POZYTYWNA WZROSŁA!", "Siła postaci została zwiększona."},
            textDown = {"CECHA POZYTYWNA SPADŁA!", "Siła postaci została zmniejszona."},
            type = "positive",
            index = 1,
        ...
        ["lungs"] = {
            textUp = {"CECHA POZYTYWNA WZROSŁA!", "Wytrzymałość postaci została zwiększona."},
            textDown = {"CECHA POZYTYWNA SPADŁA!", "Wytrzymałość postaci została zmniejszona."},
            type = "positive",
            index = 2,
        ...
        ["steer"] = {
            textUp = {"CECHA POZYTYWNA WZROSŁA!", "Umiejętność prowadzenia została zwiększona."},
            textDown = {"CECHA POZYTYWNA SPADŁA!", "Umiejętność prowadzenia została zmniejszona."},
            type = "positive",
            index = 3,
        ...
        ["weapon"] = {
            textUp = {"CECHA POZYTYWNA WZROSŁA!", "Umiejętność strzelania została zwiększona."},
            textDown = {"CECHA POZYTYWNA SPADŁA!", "Umiejętność strzelania została zmniejszona."},
            type = "positive",
            index = 4,
        ...
        ["medicine"] = {
            textUp = {"CECHA POZYTYWNA WZROSŁA!", "Wiedza medyczna została zwiększona."},
            textDown = {"CECHA POZYTYWNA SPADŁA!", "Wiedza medyczna została zmniejszona."},
            type = "positive",
            index = 5,
        ...
        ["fat"] = {
            textUp = {"CECHA NEGATYWNA WZROSŁA!", "Stopień otyłości wzrósł."},
            textDown = {"CECHA NEGATYWNA SPADŁA!", "Stopień otyłości spadł."},
            type = "negative",
            index = 6,
        },
        ["casino"] = {
            textUp = {"CECHA NEGATYWNA WZROSŁA!", "Uzależnienie od hazardu wzrosło."},
            textDown = {"CECHA NEGATYWNA SPADŁA!", "Uzależnienie od hazardu spadło."},
            type = "negative",
            index = 7,
        ...
        ["cheers"] = {
            textUp = {"CECHA NEGATYWNA WZROSŁA!", "Uzależnienie od alkoholu wzrosło."},
            textDown = {"CECHA NEGATYWNA SPADŁA!", "Uzależnienie od alkoholu spadło."},
            type = "negative",
            index = 8,
        ...
        ["smoking"] = {
            textUp = {"CECHA NEGATYWNA WZROSŁA!", "Uzależnienie od nikotyny wzrosło."},
            textDown = {"CECHA NEGATYWNA SPADŁA!", "Uzależnienie od nikotyny spadło."},
            type = "negative",
            index = 9,
        ...
        ["pills"] = {
            textUp = {"CECHA NEGATYWNA WZROSŁA!", "Uzależnienie od narkotyków wzrosło."},
            textDown = {"CECHA NEGATYWNA SPADŁA!", "Uzależnienie od narkotyków spadło."},
            type = "negative",
            index = 10,
