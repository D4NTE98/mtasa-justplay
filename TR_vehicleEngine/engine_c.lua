...
--]]
ENGINE_ENABLED = true
ENGINE_VOLUME_MASTER = 0.08 -- volume multiplier
			...
			if engine then
				...
				if getVehicleEngineState(vehicle) == true and distance < ENGINE_SOUND_DISTANCE*2 then
					...
					if not data.sounds then
						...
						if ((changedGear == "up" and data.prevTurboValue > 0.2) or (not data.throttle and data.prevTurboValue > 0.2)) and engine.turbo_shifts and engine.turbo then
							local sound = 1
							if changedGear then
...
function toggleGTAEngineSounds(bool)
	setWorldSoundEnabled(7, bool, true)
	setWorldSoundEnabled(8, bool, true)
	setWorldSoundEnabled(9, bool, true)
	setWorldSoundEnabled(10, bool, true)
	setWorldSoundEnabled(11, bool, true)
	setWorldSoundEnabled(12, bool, true)
	setWorldSoundEnabled(13, bool, true)
	setWorldSoundEnabled(14, bool, true)
	setWorldSoundEnabled(15, bool, true)
	setWorldSoundEnabled(16, bool, true)
	setWorldSoundEnabled(40, bool, true)
end
