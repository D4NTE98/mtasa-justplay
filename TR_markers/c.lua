...
local prebuildedTexts = {
  -- Global
  ["exit"] = {"Wyjście z budynku", "Powrót na świeże powietrze."},
...
function MarkerStreamer:getPrebuildedText(marker, icon, data)
  ...
  if orgID then
    return "Budynek organizacji", string.format("Ten budynek należy do organizacji %s.", orgID)
  end
...
function MarkerStreamer:updateTarget(marker, icon, r, g, b, data)
  ...
  dxDrawImage(250, 0, 200, 200, self:getIcon("marker"), 0, 0, 0, tocolor(44,181,233, 255))
  dxDrawImage(286, 20, 128, 128, markerIcon, 0, 0, 0, tocolor(44,181,233, 255))
