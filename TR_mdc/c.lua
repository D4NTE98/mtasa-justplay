...
function MDC:render()
    ...
    if self.tab == "login" then
        ...
        dxDrawText("Wpisz login:", guiInfo.logo.x - 50/zoom, guiInfo.logo.y + 140/zoom, guiInfo.logo.x - 50/zoom, guiInfo.logo.y + 145/zoom, tocolor(200, 200, 200, 255 * self.alpha * guiInfo.logo.progress), 1/zoom, self.fonts.edit, "left", "bottom")
        ...
        dxDrawText("Wpisz hasło:", guiInfo.logo.x - 50/zoom, guiInfo.logo.y + 140/zoom, guiInfo.logo.x - 50/zoom, guiInfo.logo.y + 220/zoom, tocolor(200, 200, 200, 255 * self.alpha * guiInfo.logo.progress), 1/zoom, self.fonts.edit, "left", "bottom")
        ...
        dxDrawText("Zaloguj się", guiInfo.logo.x, guiInfo.logo.y + 290/zoom, guiInfo.logo.x + guiInfo.logo.w, guiInfo.logo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha * guiInfo.logo.progress), 1/zoom, self.fonts.edit, "center", "center")

    elseif self.tab == "loading" then
        dxDrawImage(guiInfo.logo.x, guiInfo.logo.y - 120/zoom * guiInfo.logo.progress, guiInfo.logo.w, guiInfo.logo.h, self.textures.logo, 0, 0, 0, tocolor(255, 255, 255, 255 * self.alpha))
        dxDrawText("Trwa wczytywanie...", guiInfo.logo.x, guiInfo.logo.y + 290/zoom, guiInfo.logo.x + guiInfo.logo.w, guiInfo.logo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "center", "center")
    ...
    elseif self.tab == "showMain" then
        ...
        dxDrawText("Trwa wczytywanie...", guiInfo.logo.x, guiInfo.logo.y + 290/zoom, guiInfo.logo.x + guiInfo.logo.w, guiInfo.logo.y + 330/zoom, tocolor(200, 200, 200, 255 - 255 * guiInfo.main.alpha), 1/zoom, self.fonts.edit, "center", "center")
    ...
    elseif self.tab == "searchPlayer" then
        ...
        dxDrawText("Wyszukaj gracza", guiInfo.logo.x, guiInfo.logo.y + guiInfo.logo.h/2 - 50/zoom, guiInfo.logo.x + guiInfo.logo.w, guiInfo.logo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.search, "center", "top")
        ...
        if self.searching then
            ...
            dxDrawText("Wyszukiwanie...", guiInfo.logo.x + 70/zoom, guiInfo.logo.y + guiInfo.logo.h/2 + 70/zoom, guiInfo.logo.x + guiInfo.logo.w - 10/zoom, guiInfo.logo.y + guiInfo.logo.h/2 + 110/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "center")
        end
    ...
    elseif self.tab == "searchVehicle" then
        ...
        dxDrawText("Wyszukaj pojazd", guiInfo.logo.x, guiInfo.logo.y + guiInfo.logo.h/2 - 50/zoom, guiInfo.logo.x + guiInfo.logo.w, guiInfo.logo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.search, "center", "top")
    ...
    elseif self.tab == "inspectVehicle" then
        dxDrawText(string.format("#ffffffPojazd: #aaaaaa%s", self.searchData.modelName), guiInfo.x + 120/zoom, guiInfo.y + 120/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.big, "left", "top", false, false, false, true)
        dxDrawText(string.format("#ffffffID Pojazdu: #aaaaaa%s", self.searchData.ID), guiInfo.x + 120/zoom, guiInfo.y + 155/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)
        dxDrawText(string.format("#ffffffWłaściciel: #aaaaaa%s", self.searchData.username), guiInfo.x + 120/zoom, guiInfo.y + 175/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)
        dxDrawText(string.format("#ffffffNumer rejestracyjny: #aaaaaaSA %s", self.searchData.plateText or string.format("%05d", tonumber(self.searchData.ID))), guiInfo.x + 120/zoom, guiInfo.y + 195/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)


    elseif self.tab == "inspectPlayer" then
        if self.searchData.isWanted then
            dxDrawText("POSZUKIWANY", guiInfo.x + 120/zoom, guiInfo.y + 120/zoom, guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 330/zoom, tocolor(173, 50, 50, 255 * self.alpha), 1/zoom, self.fonts.big, "right", "top", false, false, false, true)
            dxDrawText(string.format("#ffffffOd: #aaaaaa%s", self.searchData.isWanted or "ERROR"), guiInfo.x + 120/zoom, guiInfo.y + 150/zoom, guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "right", "top", false, false, false, true)
        else
            dxDrawText("NIE POSZUKIWANY", guiInfo.x + 120/zoom, guiInfo.y + 120/zoom, guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 330/zoom, tocolor(85, 173, 50, 255 * self.alpha), 1/zoom, self.fonts.big, "right", "top", false, false, false, true)
        end

        dxDrawText(string.format("#ffffffGracz: #aaaaaa%s", self.searchData.username), guiInfo.x + 120/zoom, guiInfo.y + 120/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.big, "left", "top", false, false, false, true)
        dxDrawText(string.format("#ffffffNick RP: #aaaaaa%s", self.searchData.usernameRP or "Brak"), guiInfo.x + 120/zoom, guiInfo.y + 155/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)
        dxDrawText(string.format("#ffffffNieopłacone mandaty: #aaaaaa$%.2f", self.searchData.ticketPrice and tonumber(self.searchData.ticketPrice) or 0), guiInfo.x + 120/zoom, guiInfo.y + 175/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)
        dxDrawText(string.format("#ffffffOdbywa karę w więzieniu: #aaaaaa%s", self.searchData.prisonData and "Tak" or "Nie"), guiInfo.x + 120/zoom, guiInfo.y + 195/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)

        dxDrawText("Notatki gracza:", guiInfo.x + 120/zoom, guiInfo.y + 250/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(255, 255, 255, 255 * self.alpha), 1/zoom, self.fonts.big, "left", "top", false, false, false, true)
        if self.playerNotes then
            if #self.playerNotes > 0 then
                ...
                dxDrawText("Brak notatek", guiInfo.x + 120/zoom, guiInfo.y + 285/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)
            end
        else
            dxDrawText("Brak notatek", guiInfo.x + 120/zoom, guiInfo.y + 285/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top", false, false, false, true)
        end
    ...
    elseif self.tab == "addNote" then
        dxDrawText("Podgląd notatki:", guiInfo.x + 120/zoom, guiInfo.y + 270/zoom, guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 330/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.big, "center", "top", false, false, false, true)
    ...
    elseif self.tab == "wanted" then
        dxDrawText("Osoby poszukiwane", guiInfo.x + 120/zoom, guiInfo.y + 120/zoom, guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 330/zoom, tocolor(255, 255, 255, 255 * self.alpha), 1/zoom, self.fonts.big, "center", "top", false, false, false, true)
        -- dxDrawText(guiGetText(self.edits.note).." ~ "..self.playerName, guiInfo.x + 120/zoom, guiInfo.y + 320/zoom, guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 500/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.note, "center", "top", true, true)
        ...
        if self.searching then
            ...
            dxDrawText("Wczytywanie listy...", guiInfo.x, guiInfo.logo.y + guiInfo.logo.h/2 + 50/zoom, guiInfo.x + guiInfo.w, guiInfo.logo.y + guiInfo.logo.h/2 + 110/zoom, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.search, "center", "center")
            ...
            if #self.wantedPlayers > 0 then
                ...
                for i = 1, 12 do
                    ...
                    if v then
                        ...
                        dxDrawText("Poszukiwany od: "..v.wantedTime, x + 80/zoom, y + 32/zoom, guiInfo.x + guiInfo.w, guiInfo.logo.y + guiInfo.logo.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.edit, "left", "top")
                    end
                end
            else
                dxDrawText("Brak osób poszukiwanych", guiInfo.x, guiInfo.logo.y, guiInfo.x + guiInfo.w, guiInfo.logo.y + guiInfo.logo.h, tocolor(200, 200, 200, 255 * self.alpha), 1/zoom, self.fonts.search, "center", "center")
            end
        end
...
function MDC:buttonClick(btn)
    ...
    elseif btn == self.buttons.addNewNote then
        if self.tab == "addNote" then
            ...
            if string.len(text) < 3 then exports.TR_noti:create("Musisz wpisać przynajmniej 3 znaki.", "error") return end
...
function MDC:response(...)
    ...
    if self.tab == "searchVehicle" then
        ...
        if arg[1] == "noVehicle" then
            exports.TR_noti:create("Taki gracz nie został znaleziony.", "error")
            exports.TR_dx:setButtonVisible(self.buttons.search, true)
            return
        end
