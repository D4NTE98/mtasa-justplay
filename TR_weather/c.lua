...
function WeatherSystem:render()
    ...
    if self.state then
        ...
        dxDrawText(self.info.zone, guiInfo.x + guiInfo.h + 5/zoom, guiInfo.y + 13/zoom, guiInfo.x + guiInfo.w, guiInfo.y, tocolor(44,181,233, 255 * self.alpha), 1/zoom, self.fonts.main, "left", "top")
