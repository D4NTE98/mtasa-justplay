...
function renderTalk()
  renderAnim()
  drawBackground(settings.x, settings.y, settings.w, settings.h, tocolor(23,25,31, 255), 15)
  dxDrawText("Wybierz opcję dialogową", settings.x, settings.y + 10/zoom, settings.x + settings.w, settings.y + settings.fontHeight, tocolor(44,181,233, 255), 1/zoom, settings.font, "center")
