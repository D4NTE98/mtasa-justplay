...
local guiInfo = {
    ...
    volumes = {
        {"GLOSNO", 1}, {"SREDNIO", 0.6}, {"CICHO", 0.2}, {"WYCISZONY", 0}
    },
...
function Phone:drawScreen()
    ...
    elseif self.tab == "menu" then
        dxDrawText("WYBIERZ", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    elseif self.tab == "ringTones" then
        dxDrawText("USTAW", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    elseif self.tab == "ringTonesNew" then
        ...
        dxDrawText(string.format("USTAWIONO %s JAKO NOWY DZWONEK", self.newRingtone), guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "center", true, true)

    elseif self.tab == "volumeNew" then
        dxDrawText("OK", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
        dxDrawText(string.format("USTAWIONO GLOSNOSC NA %s", self.newVolume), guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "center", true, true)
    ...
    elseif self.tab == "calling" then
        dxDrawText("DZWONIENIE", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    elseif self.tab == "acceptCall" then
        dxDrawText("POL. PRZYCH. OD", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
        dxDrawText(self.phoningPlayerName, guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 180/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.number, "right", "center", true, true)

    elseif self.tab == "notPickedUp" then
        dxDrawText("NIEOD. POL.", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    elseif self.tab == "speaking" then
        ...
        dxDrawText("ROZMOWA TRWA", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    elseif self.tab == "decline" then
        dxDrawText("POL. ODRZUCONE", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    elseif self.tab == "endCall" then
        ...
        dxDrawText("POL. ZAKONCZONE", guiInfo.x + 34/zoom, guiInfo.y + 68/zoom, guiInfo.x + 188/zoom, guiInfo.y + 216/zoom, tocolor(26, 28, 22, 255 * self.alpha), 1/zoom, self.fonts.menu, "center", "bottom")
    ...
    if arg[1] == "left" and arg[2] == "down" then
        ...
        elseif self.tab == "acceptCall" then
            if self:isMouseInPosition(guiInfo.x + 24/zoom, guiInfo.y + 280/zoom, 42/zoom, 50/zoom) then
                ...
                exports.TR_noti:create("Aby powiedzieć coś przez telefon, użyj komendy /t [wiadomość] na chacie.", "info", 5)
...
function Phone:customNumberEffect(...)
    ...
    self.phoningTimer = setTimer(function()
        ...
        if arg[1] == "taxi" then
            ...
            exports.TR_chat:showCustomMessage("#009688Dyspozytor taxi", "#2a8c44Dzień dobry. Przypominam, że rozmowa jest nagrywana. W czym mogę służyć?", "files/images/call.png")
            self.phoningTimer = setTimer(function()
                exports.TR_chat:showCustomMessage(string.format("#009688[%d] %s", id, name), string.format("#2a8c44Dzień dobry. Chciałbym zamówić taksówkę na %s.", zone), "files/images/call.png")
                ...
                self.phoningTimer = setTimer(function()
                    ...
                    if int == 0 and dim == 0 then
                        exports.TR_chat:showCustomMessage("#009688Dyspozytor taxi", "#2a8c44Zgłoszenie zostało przekazane do centrali. Informacja o przyjęciu zgłoszenia przez naszego taksówkarza zostanie wysłana SMS. Dziękuję za rozmowę. Do widzenia.", "files/images/call.png")
                        triggerServerEvent("addTaxiRequest", resourceRoot)

                        exports.TR_achievements:addAchievements("getTaxi")
                    else
                        exports.TR_chat:showCustomMessage("#009688Dyspozytor taxi", "#2a8c44Przepraszam, ale nie możemy wysłać taksówki pod wskazany adres. Za utrudnienia przepraszamy. Do widzenia.", "files/images/call.png")
                    end
        ...
        elseif arg[1] == "pomoc drogowa" then
            self.speakingPlayerName = self.phoningPlayerName
            self.speakingTime = getTickCount()
            ...
            exports.TR_chat:showCustomMessage("#009688Dyspozytor pomocy drogowej", "#2a8c44Dzień dobry. Przypominam, że rozmowa jest nagrywana. W czym mogę służyć?", "files/images/call.png")
            exports.TR_noti:create("Użyj komendy /t (treść), aby napisać treść zgłoszenia.", "info", 10)

        elseif arg[1] == "alarmowy" then
            self.speakingPlayerName = self.phoningPlayerName
            self.speakingTime = getTickCount()
            ...
            exports.TR_chat:showCustomMessage("#009688Dyspozytor 911", "#2a8c44Dzień dobry. Przypominam, że rozmowa jest nagrywana. W czym mogę służyć?", "files/images/call.png")
            exports.TR_noti:create("Użyj komendy /t (p/f/m) (treść), aby napisać treść zgłoszenia.", "info", 10)   
        end
...
function Phone:setCustomText(...)
    ...
    if self.customNumber == "alarmowy" then
        ...
        if getElementInterior(localPlayer) ~= 0 or getElementDimension(localPlayer) ~= 0 then
            exports.TR_chat:showCustomMessage("#009688Dyspozytor 911", "#2a8c44Przepraszam ale ledwo co słyszę. Chyba zasięg jest zbyt słaby w budynku. Jakbym mógł prosić o wyjście na dwór to byłoby cudownie.", "files/images/call.png")
            self.getText = nil
            return
        end

        if fraction ~= "p" and fraction ~= "f" and fraction ~= "m" then
            exports.TR_noti:create("Dostępne frakcje:\np - policja, m - medyki, f - straż pożarna.", "info", 7)
            exports.TR_chat:showCustomMessage("#009688Dyspozytor 911", "#2a8c44Przepraszam, ale nie rozumiem jakie służby są potrzebne. Proszę powtórzyć zgłoszenie.", "files/images/call.png")
            self.getText = nil
            return
        end
        ...
        self.phoningTimer = setTimer(function()
            exports.TR_chat:showCustomMessage("#009688Dyspozytor 911", "#2a8c44Zgłoszenie zostało przekazane do centrali. Dziękuję za rozmowę. Do widzenia.", "files/images/call.png")
    ...
    elseif self.customNumber == "pomoc drogowa" then
        self.getText = true
        ...
        if getElementInterior(localPlayer) ~= 0 or getElementDimension(localPlayer) ~= 0 then
            exports.TR_chat:showCustomMessage("#009688Dyspozytor pomocy drogowej", "#2a8c44Przepraszam ale ledwo co słyszę. Chyba zasięg jest zbyt słaby w budynku. Jakbym mógł prosić o wyjście na dwór to byłoby cudownie.", "files/images/call.png")
            self.getText = nil
            return
        end
        ...
        self.phoningTimer = setTimer(function()
            exports.TR_chat:showCustomMessage("#009688Dyspozytor pomocy drogowej", "#2a8c44Zgłoszenie zostało przekazane do centrali. Dziękuję za rozmowę. Do widzenia.", "files/images/call.png")
