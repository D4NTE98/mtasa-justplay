...
function adminAcceptQuestion(btn)
	...
	if string.len(question) < 10 then exports.TR_noti:create("Pytanie powinno zawierać powyżej 10 znaków.", "error") return end
...
function renderAdminOX()
	...
	dxDrawText("Wpisz pytanie eventowe", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(240, 196, 55, 255), 1/zoom, guiInfo.fonts.main, "center", "center")
end
