...
function Computer:renderAddObject()
    ...
    dxDrawText("Anuluj", guiInfo.addObject.x + 10/zoom, guiInfo.addObject.y + guiInfo.addObject.h - 40/zoom, guiInfo.addObject.x + (guiInfo.addObject.w - 30/zoom)/2 + 10/zoom, guiInfo.addObject.y + guiInfo.addObject.h - 10/zoom, tocolor(160, 160, 160, 255 * self.alpha), 1/zoom, self.fonts.icons, "center", "center")
...
function Computer:renderWindowsBarIcon(i, img)
    ...
    if self.iconBar == i then
        ...
        if self.iconBar == 0 then
            ...
            dxDrawText("Wyłącz komputer", guiInfo.bar.x + 35/zoom + i * 48/zoom, guiInfo.bar.y - 32/zoom, guiInfo.bar.x + 192/zoom + i * 48/zoom, guiInfo.bar.y - 4/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.closeApp, "left", "center", false, false, true)
        else
            ...
            dxDrawText("Zamknij okno", guiInfo.bar.x + 35/zoom + i * 48/zoom, guiInfo.bar.y - 32/zoom, guiInfo.bar.x + 192/zoom + i * 48/zoom, guiInfo.bar.y - 4/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.closeApp, "left", "center", false, false, true)
        end
    end
end
...
function Computer:renderAppWindow()
    ...
    if self.focusedAppData then
        if self.focusedAppData.data then
            dxDrawText(string.format("Ilość elementów: %d", #self.focusedAppData.data), self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false, true)
        ...
        elseif self.focusedAppData.info then
            ...
            dxDrawText(string.format("Wybrany element: %s", self.focusedAppData.element), self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false, true)
...
function Computer:renderInfoAppWindow()
    if self.windowSize.size == "full" then
        ...
        dxDrawText("EIN:", self.windowSize.x + 10/zoom, self.windowSize.y + 665/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Założyciel:", self.windowSize.x + 10/zoom, self.windowSize.y + 685/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Data założenia:", self.windowSize.x + 10/zoom, self.windowSize.y + 705/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        ...
        dxDrawText("Ilość członków:", self.windowSize.x + 10/zoom, self.windowSize.y + 725/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Ilość pojazdów:", self.windowSize.x + 10/zoom, self.windowSize.y + 745/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Organizacja opłacona do:", self.windowSize.x + 10/zoom, self.windowSize.y + 765/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        ...
        dxDrawText(string.format("Wybrany element: %s", self.focusedAppData.data.name), self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h + 170/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false)
    else
        if self.textures.orgLogo then
        ...
        dxDrawText("EIN:", self.windowSize.x + 10/zoom, self.windowSize.y + 365/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Założyciel:", self.windowSize.x + 10/zoom, self.windowSize.y + 385/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Data założenia:", self.windowSize.x + 10/zoom, self.windowSize.y + 405/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        ...
        dxDrawText("Ilość członków:", self.windowSize.x + 10/zoom, self.windowSize.y + 425/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Ilość pojazdów:", self.windowSize.x + 10/zoom, self.windowSize.y + 445/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        dxDrawText("Organizacja opłacona do:", self.windowSize.x + 10/zoom, self.windowSize.y + 465/zoom, self.windowSize.x + self.windowSize.w/2 - 5/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "right", "top", false, false)
        ...
        dxDrawText(string.format("Wybrany element: %s", self.focusedAppData.data.name), self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false)
    end
...
function Computer:renderEarningsAppWindow()
    ...
    if #self.earnData > 0 then
        ...
        dxDrawText(string.format("Przychód organizacji w przeciągu 7 ostatnich dni wyniósł $%.2f", self.earnDiagram.totalEarn), diagram.x + diagram.w/2, diagram.y + diagram.h + 30/zoom, diagram.x + diagram.w/2, diagram.y + diagram.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "center", "top", false, false, true)

    else
        dxDrawText("Twoja organizacja nie zarobiła jeszcze żadnych pieniędzy.", diagram.x + diagram.w/2, diagram.y, diagram.x + diagram.w/2, diagram.y + diagram.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "center", "center", false, false, true)
    end
    ...
    dxDrawText("Wpłać pieniądze na rzecz organizacji", self.windowSize.x + self.windowSize.w/2 - (self.windowSize.w/2 - 300/zoom)/2 - 300/zoom, self.windowSize.y + self.windowSize.h - 75/zoom, self.windowSize.x + self.windowSize.w/2 - (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 40/zoom, tocolor(160, 160, 160, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "center", "center")

    if self:isMouseInPosition(self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom, self.addObjectTitle) and not self.addObjectTitle then
        dxDrawRectangle(self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom, tocolor(47, 47, 47, 255 * self.alpha))
        dxDrawText("Wypłać dodatkowe wynagrodzenie", self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2 + 300/zoom, self.windowSize.y + self.windowSize.h - 40/zoom, tocolor(160, 160, 160, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "center", "center")
    else
        dxDrawRectangle(self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom, tocolor(37, 37, 37, 255 * self.alpha))
        dxDrawText("Wypłać dodatkowe wynagrodzenie", self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2 + 300/zoom, self.windowSize.y + self.windowSize.h - 40/zoom, tocolor(160, 160, 160, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "center", "center")
    end
    ...
    dxDrawText("Wybrany element: Finanse", self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false, true)
end
...
function Computer:renderDarkWebAppWindow()
    if self.focusedAppData.window == "main" then
        ...
        dxDrawText("Dział używek", self.windowSize.x + 10/zoom, self.windowSize.y + 310/zoom, self.windowSize.x + self.windowSize.w/2 - 10/zoom, self.windowSize.y + self.windowSize.h, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.orgName, "center", "top", false, false, true)
        dxDrawText("Wybierając tę opcję możesz ujrzeć ogłoszenia dotyczące sprzedaży wszelakich używek, od dopalaczy czy haszyszu po wszelkie inne tego typu narkotyki dostępne w stanie San Andreas. Wystarczy, że zobaczysz w której dzielnicy możesz spotkać dilera i o której godzinie. Wszystkie te dane możesz uzyskać czytając ogłoszenia lokalnych sprzedawców.", self.windowSize.x + 15/zoom, self.windowSize.y + 350/zoom, self.windowSize.x + self.windowSize.w/2 - 15/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", true, true)

        dxDrawText("Dział broni", self.windowSize.x + self.windowSize.w/2 + 10/zoom, self.windowSize.y + 310/zoom, self.windowSize.x + self.windowSize.w - 10/zoom, self.windowSize.y + self.windowSize.h, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.orgName, "center", "top", false, false, true)
        dxDrawText("Wybierając tę opcję możesz ujrzeć ogłoszenia dotyczące sprzedaży broni, od najmniejszego kalibru pistoletów aż po potężne karabiny szturmowe dalekiego zasięgu. Wystarczy, że zobaczysz w której dzielnicy możesz spotkać sprzedawcę i o której godzinie. Wszystkie te dane możesz uzyskać czytając ogłoszenia lokalnych handlarzy.", self.windowSize.x + self.windowSize.w/2 + 15/zoom, self.windowSize.y + 350/zoom, self.windowSize.x + self.windowSize.w - 15/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", true, true)

        dxDrawText("Połączenie: Prywatne", self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false, true)


    elseif self.focusedAppData.window == "weapon" then
        if not self.focusedAppData.data then
            dxDrawText("Wczytywanie ogłoszeń...", self.windowSize.x, self.windowSize.y, self.windowSize.x + self.windowSize.w, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "center", true, true)
        else
            if #self.focusedAppData.data < 1 then
                dxDrawText("Nie ma żadnych ogłoszeń na dzisiejszy dzień.", self.windowSize.x, self.windowSize.y, self.windowSize.x + self.windowSize.w, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "center", true, true)
            else
                dxDrawText("Lokalizacja", self.windowSize.x + 20/zoom, self.windowSize.y + 35/zoom, self.windowSize.x + self.windowSize.w - 20/zoom, self.windowSize.y + 70/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "left", "center")
                dxDrawText("Sprzedawany towar", self.windowSize.x + 300/zoom, self.windowSize.y + 35/zoom, self.windowSize.x + self.windowSize.w - 20/zoom, self.windowSize.y + 70/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "left", "center")
                dxDrawText("Godzina", self.windowSize.x + self.windowSize.w - 100/zoom, self.windowSize.y + 35/zoom, self.windowSize.x + self.windowSize.w - 20/zoom, self.windowSize.y + 70/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "center")
        ...
        dxDrawText("Połączenie: Prywatne - Broń", self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false, true)
    ...
    elseif self.focusedAppData.window == "drugs" then
        ...
        dxDrawText("Połączenie: Prywatne - Używki", self.windowSize.x + 10/zoom, self.windowSize.y + self.windowSize.h - 30/zoom, self.windowSize.x + 8/zoom, self.windowSize.y + self.windowSize.h, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.icons, "left", "center", false, false, true)
    end
end
...
function Computer:renderUpgradeAppWindow()
    ...
    dxDrawText("Limit pracowników", self.windowSize.x + 10/zoom, self.windowSize.y + 250/zoom, self.windowSize.x + 290/zoom, self.windowSize.y + self.windowSize.h, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.upgradeName, "center", "top", false, false, true)
    dxDrawText(string.format("Koszt: $%s", self:formatNumber(self.leaderData.info.players * 15000)), self.windowSize.x + 10/zoom, self.windowSize.y + 280/zoom, self.windowSize.x + 290/zoom, self.windowSize.y + self.windowSize.h, tocolor(184, 153, 53, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)
    dxDrawText("Limit pojazdów", self.windowSize.x + 310/zoom, self.windowSize.y + 250/zoom, self.windowSize.x + 590/zoom, self.windowSize.y + self.windowSize.h, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.upgradeName, "center", "top", false, false, true)
    dxDrawText(string.format("Koszt: $%s", self:formatNumber(self.leaderData.info.vehicles * 20000)), self.windowSize.x + 310/zoom, self.windowSize.y + 280/zoom, self.windowSize.x + 590/zoom, self.windowSize.y + self.windowSize.h, tocolor(184, 153, 53, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)
    dxDrawText("Wysokość zarobku", self.windowSize.x + 610/zoom, self.windowSize.y + 250/zoom, self.windowSize.x + self.windowSize.w - 10/zoom, self.windowSize.y + self.windowSize.h, tocolor(220, 220, 220, 255 * self.alpha), 1/zoom, self.fonts.upgradeName, "center", "top", false, false, true)
    dxDrawText(string.format("Koszt: $%s", self:formatNumber((self.leaderData.info.moneyBonus * 50000) + 50000)), self.windowSize.x + 610/zoom, self.windowSize.y + 280/zoom, self.windowSize.x + self.windowSize.w - 10/zoom, self.windowSize.y + self.windowSize.h, tocolor(184, 153, 53, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)

    dxDrawText("Te ulepszenie pozwoli Ci zatrudnić większą ilość pracowników. Od ilości graczy w organizacji zależy bowiem jej przychód. Zwiększenie maksymalnego limitu i zatrudnienie kilku dodatkowych osób pozwoli organizacji szybciej się rozwinąć.", self.windowSize.x + 10/zoom, self.windowSize.y + 320/zoom, self.windowSize.x + 290/zoom, self.windowSize.y + self.windowSize.h - 40/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.closeApp, "center", "top", true, true, true)
    dxDrawText(string.format("Aktualny limit: %d", self.leaderData.info.players * 5), self.windowSize.x + 10/zoom, self.windowSize.y + 470/zoom, self.windowSize.x + 290/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)
    dxDrawText(string.format("Powiększony limit: %d", self.leaderData.info.players * 5 + 5), self.windowSize.x + 10/zoom, self.windowSize.y + 495/zoom, self.windowSize.x + 290/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)

    dxDrawText("Te ulepszenie pozwoli Ci przypisać do organizacji większą liczbę pojazdów. Jeśli chcesz zadbać o swoich pracowników, a niektórzy z nich chcą się podzielić swoimi pojazdami, przypisz je do organizacji. Dzięku temu dojazd do pracy stanie się łatwiejszy.", self.windowSize.x + 310/zoom, self.windowSize.y + 320/zoom, self.windowSize.x + 590/zoom, self.windowSize.y + self.windowSize.h - 40/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.closeApp, "center", "top", true, true, true)
    dxDrawText(string.format("Aktualny limit: %d", self.leaderData.info.vehicles * 3), self.windowSize.x + 310/zoom, self.windowSize.y + 470/zoom, self.windowSize.x + 590/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)
    dxDrawText(string.format("Powiększony limit: %d", self.leaderData.info.vehicles * 3 + 3), self.windowSize.x + 310/zoom, self.windowSize.y + 495/zoom, self.windowSize.x + 590/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)

    dxDrawText("Te ulepszenie pozwoli Ci zwiększyć zarobek organizacji jak i pracowników. Im większe będą przychody organizacji, tym większe będą wynagrodzenia, które będziesz mógł wypłacić swoim pracownikom. Na pewno ucieszą się z wyższych wypłat.", self.windowSize.x + 610/zoom, self.windowSize.y + 320/zoom, self.windowSize.x + self.windowSize.w - 10/zoom, self.windowSize.y + self.windowSize.h - 40/zoom, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.closeApp, "center", "top", true, true, true)
    dxDrawText(string.format("Aktualny zarobek: +%d%%", self.leaderData.info.moneyBonus + 5), self.windowSize.x + 610/zoom, self.windowSize.y + 470/zoom, self.windowSize.x + self.windowSize.w - 10/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)
    dxDrawText(string.format("Powiększony zarobek: +%d%%", self.leaderData.info.moneyBonus + 6), self.windowSize.x + 610/zoom, self.windowSize.y + 495/zoom, self.windowSize.x + self.windowSize.w - 10/zoom, self.windowSize.y + self.windowSize.h, tocolor(170, 170, 170, 255 * self.alpha), 1/zoom, self.fonts.infoApp, "center", "top", false, false, true)
end
            ...
            if v.type == "resize" then
                if self.windowSize.size == "full" then
                    if self.blockResize then
                        self:renderCursorHint("Ta aplikacja nie obsługuje trybu okienkowego")
                        ...
                        self:renderCursorHint("Minimalizuj")
                    end

                else
                    if self.blockResize then
                        self:renderCursorHint("Ta aplikacja nie obsługuje trybu pełnoekranowego")
                        ...
                        self:renderCursorHint("Maksymalizuj")
                    end
                end
...
function Computer:renderNotificationList()
    ...
    dxDrawText("Powiadomienia", guiInfo.noti.x, guiInfo.noti.y + 10/zoom, guiInfo.noti.x + guiInfo.noti.w, guiInfo.noti.y, tocolor(140, 140, 140, 255 * self.alpha), 1/zoom, self.fonts.titleApp, "center", "top", false, false, true)
...
function Computer:mouseClick(key, state)
    ...
    elseif self.addObjectTitle then
        if self:isMouseInPosition(guiInfo.addObject.x + 10/zoom, guiInfo.addObject.y + guiInfo.addObject.h - 40/zoom, (guiInfo.addObject.w - 30/zoom)/2, 30/zoom) then
            if self.addObjectTitle == "Dodatkowe wynagrodzenie" then
        ...
        elseif self:isMouseInPosition(guiInfo.addObject.x + guiInfo.addObject.w - (guiInfo.addObject.w - 30/zoom)/2 - 10/zoom, guiInfo.addObject.y + guiInfo.addObject.h - 40/zoom, (guiInfo.addObject.w - 30/zoom)/2, 30/zoom) then
            ...
            if guiInfo.apps[self.focusedApp].type == "folder_person" then
                if string.len(text) < 3 or string.len(text) > 20 then self:showInfo("Wprowadzony tekst jest niepoprawny.", "error") return end

                local text = guiGetText(self.edits.edit)
                if text == getPlayerName(localPlayer) then self:showInfo("Nie możesz dodać samego siebie jako pracownika.", "error") return end

                local player = getPlayerFromName(text)
                if not player or not isElement(player) then self:showInfo("Taka osoba nie została znaleziona.", "error") return end

                for i, v in pairs(self.leaderData[guiInfo.apps[self.focusedApp].type]) do
                    if v.name == text then
                        self:showInfo("Taka osoba znajduje się już na liście pracowników.", "error")
                        return
                    end
                end

                if getElementInterior(player) ~= getElementInterior(localPlayer) then self:showInfo("Ta osoba znajduje się zbyt daleko od ciebie.", "error") return end
                if getElementDimension(player) ~= getElementDimension(localPlayer) then self:showInfo("Ta osoba znajduje się zbyt daleko od ciebie.", "error") return end
                ...
                --tutaj trzeba dodac warunek uwzględniający daną frakcje
            ...
            elseif guiInfo.apps[self.focusedApp].type == "folder_ranks" then
                if self.selectedObjectOptions[self.hoveredOption].type == "rename" then
                    if string.len(text) < 3 or string.len(text) > 32 then self:showInfo("Wprowadzony tekst jest niepoprawny.", "error") return end

                    for i, v in pairs(self.leaderData[guiInfo.apps[self.focusedApp].type]) do
                        if v.name == text then
                            self:showInfo("Taka ranga już istnieje.", "error")
                            return
                        end
                    end
            ...
            elseif guiInfo.apps[self.focusedApp].type == "info" then
                if self.addObjectTitle == "Zmiana loga organizacji" then
                    if string.len(text) < 5 then self:showInfo("Wprowadzony link jest niepoprawny.", "error") return end
                    if isLink(text) ~= 1 then self:showInfo("Wprowadzony link jest niepoprawny.", "error") return end
                    if not string.find(text, "imgur") then self:showInfo("Wprowadzony link nie jest linkiem do imgura.", "error") return end
                    if not string.find(text, ".png") then self:showInfo("Wprowadzony link nie jest bezpośrednim linkiem do obrazu .png.", "error") return end
            ...
            elseif guiInfo.apps[self.focusedApp].type == "earnings" then
                if self.addObjectTitle == "Wpłata na rzecz ogranizacji" then
                    local amount = tonumber(text)

                    if string.len(text) < 1 then self:showInfo("Wprowadzona kwota jest niepoprawna.", "error") return end
                    if amount == nil then self:showInfo("Wprowadzona kwota jest niepoprawna.", "error") return end

                    exports.TR_dx:setEditText(self.edits.edit, string.format("%.2f", amount))

                    if amount < 0.01 then
                        self:showInfo("Wprowadzona kwota musi być większa od \n$0.01.", "error")
                        return
                    end
                    ...
                    if money < amount then
                        self:showInfo("Nie posiadasz przy sobie tylu pieniędzy.", "error")
                        return
                    end
                ...
                elseif self.addObjectTitle == "Dodatkowe wynagrodzenie" then
                    if string.len(text) < 1 then self:showInfo("Wprowadzony gracz jest niepoprawny.", "error") return end
                    ...
                    if self.responseInfo then
                        if self.responseInfo.type == "additionalPaymentPlayer" then
                            ...
                            if tonumber(self.leaderData["info"].money) < amount then
                                self:showInfo("Organizacja nie posiada tylu pieniędzy.", "error")
                                return
                            end
                    ...
                    for i, v in pairs(self.leaderData.folder_person) do
                        if v.name == text then
                            ...
                            self:addObject("Dodatkowe wynagrodzenie", "Kwota", false, "Wypłać")
                            return
                        end
                    end

                    self:showInfo("W tej organizacji nie pracuje taka osoba.", "error")
                end


            elseif guiInfo.apps[self.focusedApp].type == "darkweb" then
                if self.responseInfo.type == "setDarkWebLocation" then
                    if string.len(text) < 5 or string.len(text) > 100 then self:showInfo("Lokalizacja powinna zawierać od 5 do 100 znaków.", "error") return end

                    self.responseInfo = {
                        type = "setDarkWebText",
                        location = text,
                    }
                    self:addObject("Przedmiot i cena", "Podaj przedmiot oraz cenę", false, "Dalej")

                elseif self.responseInfo.type == "setDarkWebText" then
                    if string.len(text) < 5 or string.len(text) > 100 then self:showInfo("Przedmiot oraz cena powinny zawierać od 5 do 100 znaków.", "error") return end
                    ...
                    self:addObject("Godzina spotkania", "Podaj godzinę spotkania", false, "Dodaj")

                elseif self.responseInfo.type == "setDarkWebHour" then
                    if string.len(text) < 0 or string.len(text) > 5 then self:showInfo("Godzina powinna zawierać od 0 do 5 znaków.", "error") return end
                ...
                if self.leaderData.folder_ranks then
                    ...
                    for k, rank in pairs(self.leaderData.folder_ranks) do
                        if self:isMouseInPosition(self.selectedObjectPos.x + self.selectedObjectPos.w + 2/zoom, posY + (k-1) * 25/zoom, self.selectedObjectPos.w, 25/zoom, true) then
                            ...
                            if not playerRank or not canManage then self:showInfo("Nie masz dostępu do tej opcji.", "error"); self.selectedObject = nil return end
                            if self.selectedObjectData.name == playerName then self:showInfo("Nie możesz zmienić rangi samemu sobie.", "error"); self.selectedObject = nil return end
                            ...
                            for i, v in pairs(self.leaderData[guiInfo.apps[self.focusedApp].type]) do
                                if self.selectedObjectData.name == v.name then
                                    ...
                                    if playerRank <= rank.level then
                                        self:showInfo("Nie możesz zmienić rangi tego pracownika na rangę wyższą lub równą twojej.", "error")
                                        self.selectedObject = nil
                                        return

                                    elseif playerRank <= targetRank then
                                        self:showInfo("Nie możesz zmienić rangi tego pracownika, ponieważ posiada on rangę wyższą od twojej.", "error")
                                        self.selectedObject = nil
                                        return
                                    end
                ...
                if self:isMouseInPosition(self.selectedObjectPos.x, self.selectedObjectPos.y + (self.hoveredOption-1) * 25/zoom, self.selectedObjectPos.w, 25/zoom) then
                    if self.selectedObjectOptions[self.hoveredOption].type == "remove" then
                        if guiInfo.apps[self.focusedApp].type == "folder_person" then
                            ...
                            if self.computerType == "fraction" then
                                if not playerRank or not canManage then self:showInfo("Nie masz dostępu do tej opcji.", "error"); self.selectedObject = nil return end
                                if self.selectedObjectData.name == playerName then self:showInfo("Nie możesz zwolnić samego siebie.", "error") self.selectedObject = nil return end
                            ...
                            for i, v in pairs(self.leaderData[guiInfo.apps[self.focusedApp].type]) do
                                if self.selectedObjectData.name == v.name then
                                    ...
                                    if playerRank <= targetRank and v.name ~= playerName then
                                        self:showInfo("Nie możesz zwolnić tego pracownika.", "error")
                                        self.selectedObject = nil
                                        return
                                    end
                                    ...
                                    if self.computerType == "organization" then
                                        if self.leaderData.info.owner == v.name then
                                            self:showInfo("Nie możesz zwolnić właściciela organizacji.", "error")
                                            self.selectedObject = nil
                                            return
                                        end
                                    end
                                    ...
                                    if v.name == playerName then
                                        self:openAcceptWindow("Zwalnianie pracownika", "Czy na pewno chcesz zwolić samego siebie?", "remove", i)
                                    else
                                        self:openAcceptWindow("Zwalnianie pracownika", string.format("Czy na pewno chcesz zwolić gracza %s?", v.name), "remove", i)
                                    end
                                    self.selectedObject = nil
                                    return
                                end
                        ...
                        elseif guiInfo.apps[self.focusedApp].type == "folder_ranks" then
                            ...
                            if not canManage then self:showInfo("Nie masz dostępu do tej opcji.", "error"); self.selectedObject = nil return end
                            ...
                            if self.selectedObject == 1 or self.selectedObject == #self.leaderData[guiInfo.apps[self.focusedApp].type] then
                                self:showInfo("Nie możesz usunąć podstawowej rangi.", "error")
                                self.selectedObject = nil
                                return
                            end

                            self:openAcceptWindow("Usuwanie rangi", string.format("Czy na pewno chcesz usunąć rangę %s?", data.name), "remove", self.selectedObject)
                            self.selectedObject = nil
                        end
                    ...
                    elseif self.selectedObjectOptions[self.hoveredOption].type == "add" then
                        if guiInfo.apps[self.focusedApp].type == "folder_person" then
                            ...
                            self:addObject("Dodawanie nowego pracownika", "Wpisz nick")
                        ...
                        elseif guiInfo.apps[self.focusedApp].type == "folder_ranks" then
                            ...
                            if #self.leaderData.folder_ranks >= 20 then
                                self:showInfo("Nie możesz dodać więcej rang, ponieważ limit został osiągnięty.", "error")
                                self.selectedObject = nil
                                return
                            end
                            ...
                            self:addObject("Dodawanie nowej rangi", "Wpisz nazwę rangi")
                        end
                    ...
                    elseif self.selectedObjectOptions[self.hoveredOption].type == "rename" then
                        ...
                        self:addObject("Edytowanie rangi", "Wpisz nazwę rangi", rankName, "Zapisz")
                    ...
                    elseif self.selectedObjectOptions[self.hoveredOption].type == "declineVehicle" then
                        ...
                        self:openAcceptWindow("Odrzucanie pojazdu", "Czy na pewno chcesz odrzucić dodanie tego pojazdu?", "declineVehicle", self.selectedObject)
                    ...
                    elseif self.selectedObjectOptions[self.hoveredOption].type == "removeVehicle" then
                        ...
                        self:openAcceptWindow("Odpisywanie pojazdu", "Czy na pewno chcesz odpisać pojazd z organizacji?", "removeVehicle", self.selectedObject)
                    ...
                    elseif self.selectedObjectOptions[self.hoveredOption].type == "addVehicle" then
                        ...
                        self:openAcceptWindow("Przypisywanie pojazdu", "Czy na pewno chcesz przypisać pojazd do organizacji?", "addVehicle", self.selectedObject)
                    end
                end
            end
            ...
            if guiInfo.apps[self.focusedApp].type == "darkweb" then
                ...
                elseif self.focusedAppData.window == "weapon" and self.fractionType == "crime" and not self.addObjectTitle then
                    if self:isMouseInPosition(self.windowSize.x + self.windowSize.w - (self.windowSize.w - 300/zoom)/2 - 300/zoom, self.windowSize.y + self.windowSize.h - 80/zoom, 300/zoom, 35/zoom) and not self.addObjectTitle then
                        ...
                        self:addObject("Lokalizacja spotkania", "Podaj lokalizację spotkania", false, "Dalej")
                    end
                ...
                if self.focusedAppData.icon == "info" then
                    ...
                    if canManage then
                        if self:isMouseInPosition(self.windowSize.x + self.windowSize.w/2 - (self.windowSize.w/2 - 300/zoom)/2 - 300/zoom, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom) then
                            self:openAcceptWindow("Opłata organizacji", "Czy na pewno chcesz opłacić organizację na 7 dni?", "payRent", false)
                        end
                    end
                    ...
                    if self:isMouseInPosition(self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom, self.addObjectTitle) then
                        if self.organizationOwner ~= self.playerName then
                            self:showInfo("Logo organizacji może zmienić tylko jej właściciel.", "error")
                            return
                        end

                        self:addObject("Zmiana loga organizacji", "Link do imgur", false, "Zmień")
                    end
                ...
                elseif self.focusedAppData.icon == "upgrade" then
                    ...
                    if canManage then
                        if self:isMouseInPosition(self.windowSize.x, self.windowSize.y + 30/zoom, 300/zoom, self.windowSize.h - 60/zoom) then
                            self.responseInfo = {
                                type = "buyUpgrade",
                                text = "Ulepszył ilość pracowników.",
                                price = tonumber(self.leaderData.info.players * 15000),
                                index = "players",
                            }
                            self:openAcceptWindow("Kupno ulepszenia", "Czy na pewno chcesz kupić te ulepszenie?", "buyUpgrade", 1)
                        ...
                        elseif self:isMouseInPosition(self.windowSize.x + 300/zoom, self.windowSize.y + 30/zoom, 300/zoom, self.windowSize.h - 60/zoom) then
                            self.responseInfo = {
                                type = "buyUpgrade",
                                text = "Ulepszył ilość pojazdów.",
                                price = tonumber(self.leaderData.info.vehicles * 20000),
                                index = "vehicles",
                            }
                            self:openAcceptWindow("Kupno ulepszenia", "Czy na pewno chcesz kupić te ulepszenie?", "buyUpgrade", 2)
                        ...
                        elseif self:isMouseInPosition(self.windowSize.x + 600/zoom, self.windowSize.y + 30/zoom, 300/zoom, self.windowSize.h - 60/zoom) then
                            ...
                            self:openAcceptWindow("Kupno ulepszenia", "Czy na pewno chcesz kupić te ulepszenie?", "buyUpgrade", 3)
                        end
                    end

                elseif self.focusedAppData.icon == "earnings" then
                    if self:isMouseInPosition(self.windowSize.x + self.windowSize.w/2 - (self.windowSize.w/2 - 300/zoom)/2 - 300/zoom, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom) then
                        self:addObject("Wpłata na rzecz ogranizacji", "Kwota wpłaty", false, "Wpłać")
                    ...
                    elseif self:isMouseInPosition(self.windowSize.x + self.windowSize.w/2 + (self.windowSize.w/2 - 300/zoom)/2, self.windowSize.y + self.windowSize.h - 75/zoom, 300/zoom, 35/zoom, self.organizationOwner ~= self.playerName) then
                        if self.organizationOwner ~= self.playerName then
                            self:showInfo("Dodatkowe wynagrodzenie może wypłacać jedynie właściciel organizacji.", "error")
                            return
                        end

                        self:addObject("Dodatkowe wynagrodzenie", "Nick gracza", false, "Wybierz")
                    end
...
function Computer:getInfoToApp(app)
    ...
    if app == "person_info" then
        ...
        table.insert(data, {name = "Dane prywatne", value = {}})
        table.insert(data[#data].value, {name = "Nick", value = leaderData.name})
        table.insert(data[#data].value, {name = "Status", value = player and "Online" or "Offline"})
        table.insert(data[#data].value, {name = "Lokalizacja", value = player and getZoneName(getElementPosition(player)) or "Brak danych"})
        table.insert(data[#data].value, {name = "Konto stworzone", value = leaderData.created})
        table.insert(data[#data].value, {name = "Ostatnio online", value = leaderData.lastOnline})

        table.insert(data, {name = "Dane służbowe", value = {}})
        table.insert(data[#data].value, {name = "Ranga", value = rank})
        table.insert(data[#data].value, {name = "Zatrudniony od", value = leaderData.added})

        if self.computerType == "organization" then
            table.insert(data[#data].value, {name = "Wpłaty na rzecz organizacji", value = string.format("$%s", self:formatNumber(leaderData.allPaid))})
            table.insert(data[#data].value, {name = "Zarobek na rzecz organizacji", value = string.format("$%s", self:formatNumber(leaderData.allEarn))})
            table.insert(data[#data].value, {name = "Należna wypłata", value = string.format("$%s", self:formatNumber(leaderData.toPay))})

        elseif self.computerType == "fraction" then
            table.insert(data[#data].value, {name = "Tygodniowy czas na służbie", value = leaderData.weekDutyTime})
            table.insert(data[#data].value, {name = "Dzisiejszy czas na służbie", value = leaderData.todayDutyTime})
    ...
    elseif app == "vehicle_info" then
        ...
        table.insert(data, {name = "Dane pojazdu", value = {}})
        table.insert(data[#data].value, {name = "Model", value = leaderData.model})
        table.insert(data[#data].value, {name = "Nazwa", value = leaderData.name})
        table.insert(data[#data].value, {name = "Lokalizacja", value = vehicle and getZoneName(getElementPosition(vehicle)) or "Brak"})
        table.insert(data[#data].value, {name = "Ostatni kierowca", value = lastDriver})

        if self.computerType == "fraction" then
            table.insert(data[#data].value, {name = "Numer operacyjny", value = vehicle and getElementData(vehicle, "operationalNumber") or "Brak"})
        end
        element = leaderData.name
    ...
    elseif app == "ranks_info" then
        ...
        table.insert(data, {name = "Dane rangi", value = {}})
        table.insert(data[#data].value, {name = "Nazwa", value = leaderData.name})

        local permissions = self:getRankPermissions()
        if #permissions > 0 then
            table.insert(data, {name = "Uprawnienia", value = {}})
            ...
            for i, v in pairs(permissions) do
                if canManage and not isLast then
                    ...
                    table.insert(data[#data].value, {name = v.name, value = leaderData[v.value] and "Tak" or "Nie"})
                end
...
function Computer:changePermission(permission, state)
    ...
    self:showInfo(string.format("Uprawnienia rangi %s zostały zmienione.", self.openedRank.name), "success")
    table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Zmienił uprawnienia rangi %s.",  self.openedRank.name)})
...
function Computer:response(status, info, type)
    ...
    elseif self.responseInfo and status then
        if self.responseInfo.type == "addPlayer" then
            self:showInfo(string.format("Pracownik %s został pomyślnie zatrudniony.", self.responseInfo.player), "success")
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Zatrudnił gracza %s.",  self.responseInfo.player)})
        ...
        elseif self.responseInfo.type == "remove" then
            self:showInfo(string.format("Pracownik %s został pomyślnie zwolniony.", self.responseInfo.player), "success")

            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Zwolnił gracza %s.",  self.responseInfo.player)})
        ...
        elseif self.responseInfo.type == "changeRank" then
            ...
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Zmienił rangę gracza %s na %s.", self.responseInfo.player, self.responseInfo.rankName)})
            self:showInfo(string.format("Ranga pracownika %s została pomyślnie zmieniona.", self.responseInfo.player), "success")
        ...
        elseif self.responseInfo.type == "rename" then
            ...
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Zmienił nazwę rangi %s na %s.", self.responseInfo.lastRankName, self.responseInfo.text)})
            self:showInfo("Nazwa rangi została zmieniona.", "success")
        ...
        elseif self.responseInfo.type == "changeLogo" then
            self:showInfo("Zmiana loga organizacji została przyjęta do realizacji. Poczekaj na weryfikację nowego loga przez administratora.", "success")
        ...
        elseif self.responseInfo.type == "rankRemove" then
            ...
            self:showInfo("Ranga została usunięta.", "success")
            self.acceptWindowIndex = nil
        ...
        elseif self.responseInfo.type == "addRank" then
            ...
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Dodał rangę %s.", self.responseInfo.text)})
            self:showInfo("Ranga została dodana.", "success")
        ...
        elseif self.responseInfo.type == "declineVehicle" then
            ...
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Odrzucił propozycję przyjęcia pojazdu %s.", self.responseInfo.text)})
            self:showInfo("Pojazd został odrzucony.", "success")

        elseif self.responseInfo.type == "removeVehicle" then
            table.remove(self.leaderData[guiInfo.apps[self.focusedApp].type], self.responseInfo.selected)
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Odpisał pojazd %s z organizacji.", self.responseInfo.text)})
            self:showInfo("Pojazd został odpisany.", "success")
        ...
        elseif self.responseInfo.type == "addVehicle" then
            ...
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Przypisał pojazd %s do organizacji.", self.responseInfo.text)})
            self:showInfo("Pojazd został przypisany.", "success")

        elseif self.responseInfo.type == "givePayment" then
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = "Wypłacił wynagrodzenia pracownikom."})
            self:showInfo("Wynagrodzenia zostały pomyślnie wypłacone.", "success")
        ...
        elseif self.responseInfo.type == "buyUpgrade" then
            ...
            self:showInfo("Ulepszenie zostało pomyślnie zakupione.", "success")
        ...
        elseif self.responseInfo.type == "giveMoneyToOrg" then
            ...
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Wpłacił $%.2f na rzecz organizacji.", self.responseInfo.amount)})
        ...
        elseif self.responseInfo.type == "additionalPaymentPlayer" then
            table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Wypłacił dodatkowe wynagrodzenie graczowi %s w wysokości $%.2f.", self.responseInfo.player, self.responseInfo.amount)})
            self.leaderData.info.money = tonumber(self.leaderData.info.money) - self.responseInfo.amount
...
function Computer:responseData(type, data)
    ...
    elseif type == "info" then
        ...
        table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = string.format("Przeniósł siedzibę organizacji do %s.", self.responseInfo.text)})
        self:showInfo(string.format("Siedziba została przeniesiona do %s.", self.responseInfo.text), "success")
    ...
    elseif type == "info_rent" then
        ...
        table.insert(self.notifications, 1, {name = getPlayerName(localPlayer), text = "Opłacił organizację na 7 dni."})
        self:showInfo("Organizacja została opłacona na kolejne 7 dni.", "success")
...
function Computer:getRankPermissions()
    if self.fractionType == "police" then
        return {
            ...
            {
                name = "Pojazdy akademii",
                value = "veh1",
            },
            {
                name = "Pojazdy oznakowane",
                value = "veh2",
            },
            {
                name = "Pojazdy nieoznakowane",
                value = "veh3",
            },
            {
...
function cantOpenComputer(...)
    ...
    exports.TR_noti:create("Nie możesz skorzystać z tego komputera.", "error")
end
...
function openOrgComputerByKey()
    ...
    local orgID = getElementData(localPlayer, "characterOrgID")
    if not orgID then exports.TR_noti:create("Nie należysz do żadnej organizacji.", "error") return end

    exports.TR_dx:setResponseEnabled(true, "Trwa otwieranie komputera")
...
exports.TR_dx:setResponseEnabled(false)
 ...
 if getPlayerName(localPlayer) == "Xantris31231313213" then
     openOrgComputerByKey()
 end

 if getPlayerName(localPlayer) == 'Xantris213123123123' then
     openComputer()
