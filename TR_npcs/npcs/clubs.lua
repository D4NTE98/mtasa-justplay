...
function createClubsNPC()
    ...
    exports.TR_npc:addDialogueText(dialogue200, "Super tańczysz.", {pedResponse = "Dziękuję złotko."})
    exports.TR_npc:addDialogueText(dialogue200, "Może prywatny taniec? ($200 lub Diamond)", {pedResponse = "Nie ma problemu. Chodź tutaj do pokoju obok.", responseTo = "Super tańczysz.", trigger = "privateClubDance", triggerData = {1}})
    exports.TR_npc:addDialogueText(dialogue200, "Nie ma za co.", {responseTo = "Super tańczysz."})

    local dialogue400 = exports.TR_npc:createDialogue()
    exports.TR_npc:addDialogueText(dialogue400, "Super tańczysz.", {pedResponse = "Dziękuję złotko."})
    exports.TR_npc:addDialogueText(dialogue400, "Może prywatny taniec? ($400 lub Diamond)", {pedResponse = "Nie ma problemu. Chodź tutaj do pokoju obok.", responseTo = "Super tańczysz.", trigger = "privateClubDance", triggerData = {3}})
    exports.TR_npc:addDialogueText(dialogue400, "Nie ma za co.", {responseTo = "Super tańczysz."})

    for i, v in pairs(NPCs) do
        local ped = exports.TR_npc:createNPC(v.skin, v.pos.x, v.pos.y, v.pos.z, v.rot, v.name, "Striptizerka", "dialogue")
...
function createGuards()
    ...
    exports.TR_npc:addDialogueText(dialogueGuard, "Dzień dobry.", {pedResponse = "Bądź grzeczy żebym nie musiał cię wyrzucać."})

    local guard = exports.TR_npc:createNPC(163, -2641.9462890625, 1410.3083496094, 906.4609375, 133, "Max Toff", "Ochroniarz", "dialogue")
    local guard1 = exports.TR_npc:createNPC(164, -2676.1516113281, 1422.9573974609, 906.4609375, 221, "James Anders", "Ochroniarz", "dialogue")
...
function privateClubDance(ped, data)
    ...
    if dataPlr.premium ~= "diamond" then
        if exports.TR_core:takeMoneyFromPlayer(client, price) then
            ...
            exports.TR_noti:create(client, "Nie stać cię na prywatny taniec.", "error")
        end
    else
        local model = getElementModel(ped)
