...
function createCluckinNPC()
    ...
    exports.TR_npc:addDialogueText(dialogue, "Dzień dobry. Poproszę...", {pedResponse = "", img = "shop", trigger = "openShopMenu", triggerData = {"cluckin"}})
    exports.TR_npc:addDialogueText(dialogue, "Do widzenia.", {pedResponse = "Do widzenia."})

    for i, v in pairs(NPCs) do
        local ped = exports.TR_npc:createNPC(v.skin, v.pos.x, v.pos.y, v.pos.z, v.rot, v.name, "Pracownik Cluckin' Bell", "dialogue")
