...
function Licence:constructor()
    ...
    exports.TR_dx:showLoading(5000, "Wczytywanie strzelnicy")
    self:createTargets()
    return true
end
...
function Licence:close(passed)
    ...
    if passed then
        setTimer(function()
            exports.TR_noti:create("Egzamin strzelecki został zdany pomyślnie.", "success")
        end, 5000, 1)

    else
        setTimer(function()
            exports.TR_noti:create("Egzamin został oblany z powodu zbyt dużej ilości niecelnych strzałów.", "error")
        end, 5000, 1)
    end

    exports.TR_dx:showLoading(5000, "Wczytywanie świata")
...
function Licence:render()
    ...
    dxDrawText("Pozwolenie na broń", guiInfo.x + 84/zoom, guiInfo.y, guiInfo.x + guiInfo.w - 10/zoom, guiInfo.y + 25/zoom, tocolor(212, 175, 55, 255), 1/zoom, self.fonts.main, "center", "center")
    dxDrawText("Aby zaliczyć egzamin należy zestrzelić wszystkie cele znajdujące się na strzelnicy.", guiInfo.x + 84/zoom, guiInfo.y + 25/zoom, guiInfo.x + guiInfo.w - 10/zoom, guiInfo.y + guiInfo.h, tocolor(170, 170, 170, 255), 1/zoom, self.fonts.info, "center", "top", true, true)
    dxDrawText(string.format("Zestrzelone cele: #b89935%d#aaaaaa/#b89935%d", self.targetsShooted/6, self.targetsToShoot), guiInfo.x + 84/zoom, guiInfo.y + 25/zoom, guiInfo.x + guiInfo.w - 10/zoom, guiInfo.y + guiInfo.h - 10/zoom, tocolor(170, 170, 170, 255), 1/zoom, self.fonts.info, "center", "bottom", true, true, false, true)
