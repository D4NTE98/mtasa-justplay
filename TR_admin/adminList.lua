...
function AdminList:buildAdminList(...)
    ...
    table.sort(admins.globalmoderator, function(a, b) return a.username < b.username end)
...
function AdminList:render()
    ...
    dxDrawText("Skład administracji", guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(44,181,233, 255), 1/zoom, self.fonts.main, "center", "center")

    dxDrawText("Nick", guiInfo.x + 15/zoom, guiInfo.y + 40/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 70/zoom, tocolor(220, 220, 220, 255), 1/zoom, self.fonts.admin, "left", "center")
    dxDrawText("Ranga", guiInfo.x + 200/zoom, guiInfo.y + 40/zoom, guiInfo.x + guiInfo.w, guiInfo.y + 70/zoom, tocolor(220, 220, 220, 255), 1/zoom, self.fonts.admin, "left", "center")
    --dxDrawText("Reporty", guiInfo.x + 370/zoom, guiInfo.y + 40/zoom, guiInfo.x + 420/zoom, guiInfo.y + 70/zoom, tocolor(220, 220, 220, 255), 1/zoom, self.fonts.admin, "center", "center")
    dxDrawText("Czas na duty", guiInfo.x + 460/zoom, guiInfo.y + 40/zoom, guiInfo.x + 580/zoom, guiInfo.y + 70/zoom, tocolor(220, 220, 220, 255), 1/zoom, self.fonts.admin, "center", "center")
    dxDrawText("Działania", guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 40/zoom, guiInfo.x + guiInfo.w - 14/zoom, guiInfo.y + 70/zoom, tocolor(220, 220, 220, 255), 1/zoom, self.fonts.admin, "center", "center")
    ...
    for i = 1, 15 do
        ...
        if v then
            dxDrawText(v.username, guiInfo.x + 15/zoom, guiInfo.y + 75/zoom + (i-1) * 30/zoom, guiInfo.x, guiInfo.y + 105/zoom + (i-1) * 30/zoom, tocolor(170, 170, 170, 255), 1/zoom, self.fonts.admin, "left", "center")
            dxDrawText(self:firstToUpper(v.rankShow), guiInfo.x + 200/zoom, guiInfo.y + 75/zoom + (i-1) * 30/zoom, guiInfo.x, guiInfo.y + 105/zoom + (i-1) * 30/zoom, tocolor(170, 170, 170, 255), 1/zoom, self.fonts.admin, "left", "center")
            --dxDrawText(v.reports, guiInfo.x + 370/zoom, guiInfo.y + 75/zoom + (i-1) * 30/zoom, guiInfo.x + 420/zoom, guiInfo.y + 105/zoom + (i-1) * 30/zoom, tocolor(170, 170, 170, 255), 1/zoom, self.fonts.admin, "center", "center")
            dxDrawText(self:secondsToClock(v.dutyTime), guiInfo.x + 460/zoom, guiInfo.y + 75/zoom + (i-1) * 30/zoom, guiInfo.x + 580/zoom, guiInfo.y + 105/zoom + (i-1) * 30/zoom, tocolor(170, 170, 170, 255), 1/zoom, self.fonts.admin, "center", "center")
    ...
    for i = 1, 15 do
        ...
        if v then
            ...
            elseif self:isMouseInPosition(guiInfo.x + guiInfo.w - 90/zoom, guiInfo.y + 82/zoom + (i-1) * 30/zoom, 16/zoom, 16/zoom) then
                if v.rankShow == "support" or v.rankShow == "developer" then exports.TR_noti:create("Nie możesz już zdegradować tego administratora.", "success") return end
            ...
            elseif self:isMouseInPosition(guiInfo.x + guiInfo.w - 120/zoom, guiInfo.y + 82/zoom + (i-1) * 30/zoom, 16/zoom, 16/zoom) then
                if v.rankShow == "admin" then exports.TR_noti:create("Nie możesz już awansować tego administratora.", "success") return end
                local newRank = "admin"
