...
function SpecSystem:constructor(...)
    ...
    bindKey("backspace", "down", self.func.onKey)
...
function SpecSystem:destroy()
    ...
    unbindKey("backspace", "down", self.func.onKey)
...
function SpecSystem:render()
    ...
    self:drawBackground(guiInfo.x, guiInfo.y, guiInfo.w, guiInfo.h, tocolor(23,25,31, 255), 11)
    dxDrawText(self.selectedName, guiInfo.x, guiInfo.y, guiInfo.x + guiInfo.w, guiInfo.y + 50/zoom, tocolor(44,181,233, 255), 1/zoom, self.font.main, "center", "center")
    dxDrawText("Aby zmienić osobę użyj STRZAŁEK\nAby opuścić naciśnij BACKSPACE", guiInfo.x, guiInfo.y + 50/zoom, guiInfo.x + guiInfo.w, guiInfo.y + guiInfo.h - 10/zoom, tocolor(170, 170, 170, 255), 1/zoom, self.font.info, "center", "bottom", true, true)
